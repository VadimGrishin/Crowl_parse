...
2. Скачать эти документы в локальную папку (для хранения файлов в папке запуска программы пользователь должен создать вручную 
папку data и в ней подпапки standards и reglaments), одновременно провести запись в БД названия файла и наименования 
документа из соответствующего тега. Учитывать, что при наименовании документа используется версионность (использовать массив 
версий документа). При записи в БД проводить проверку наличия каждой сущности, записывать только новые.
